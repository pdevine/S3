...
//                console.log(`====routing rule ${i} does not contain Redirect?`)
//                log.warn('A RoutingRule is not well-formed', { xml });
//                return cb(errors.MalformedXML);
//            }
            // looks like AWS doesn't actually check the following:
//            parent = parent.RoutingRule[0].Redirect[0];
//            if (!(_xmlContainsRequiredElem(parent, 'ReplaceKeyPrefixWith')
//            || _xmlContainsRequiredElem(parent, 'ReplaceKeyWith')
//            || _xmlContainsRequiredElem(parent, 'HttpRedirectCode'))) {
//                log.warn('Redirect must contain either ReplaceKeyPrefixWith, ' +
//                'ReplaceKeyWith, or HttpRedirectCode element', { xml });
//                return cb(errors.MalformedXML);
//            }
//ß        }
    }
